...
<template>
  <footer>
    <div class="coffee-logo">
      <a href="https://www.buymeacoffee.com/kristiangrgic" target="_blank">
        <svg id="katman_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 600 450"
             style="enable-background:new 0 0 600 450;" xml:space="preserve">
    ...
    <div class="row-container">
      <p>No rights reserved. All code is open source.</p>
      <div class="github-icon">
        <Icon class="icon" icon="mdi:github" width="50"/>
      </div>
    </div>
  </footer>
</template>
